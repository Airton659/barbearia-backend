...
import firebase_admin  # <-- ADICIONADO: necessário para usar firebase_admin.messaging.FirebaseError nos except
...
async def agendar(
    ...
    if barbeiro and barbeiro.usuario and barbeiro.usuario.fcm_tokens:
        ...
        for token in tokens_a_enviar:
            try:
                # TROCA: firebase_admin.messaging.Message -> messaging.Message
                ...
                # TROCA: firebase_admin.Messaging(message) -> envio correto via executor
